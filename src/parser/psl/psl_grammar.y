...
Property :
TKFORALL TKATOM Opt_IndexRange TKIN ValueSet TKCOLON Expression 
{ 
  $$ = psl_expr_make_replicated_property(
     psl_expr_make_replicator(psl_expr_make_atom($2), $3, $5), $7); 
...
| TKG Sequence { PSL_EXPR_MAKE_F2F_OP($$, $2, $1); }
...
| Expression TKXOR Expression       { PSL_EXPR_MAKE_B_B2B_OP($$, $1, TKCARET, $3); } 
;
